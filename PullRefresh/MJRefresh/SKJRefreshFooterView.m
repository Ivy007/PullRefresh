...
#import "SKRefreshFooterView.h"
#import "MJRefreshConst.h"
#import "UIView+MJExtension.h"
#import "UIScrollView+MJExtension.h"

@interface SKRefreshFooterView()
@property (assign, nonatomic) NSInteger lastRefreshCount;
@end

@implementation SKRefreshFooterView

+ (instancetype)footer
{
    return [[SKRefreshFooterView alloc] init];
}
...
- (void)adjustStateWithContentOffset
{
    ...
    if (happenOffsetY - currentOffsetY < 100 &&currentOffsetY!=0)
    {
		...
		case MJRefreshStateNormal:
        {
            ...
            if (MJRefreshStateRefreshing == oldState) {
                ...
                [UIView animateWithDuration:MJRefreshFastAnimationDuration animations:^{
                    ...
                    if (self.scrollViewOriginalInset.bottom == 0) {
                        self.scrollView.mj_contentInsetBottom = 0;
                    } else if (self.scrollViewOriginalInset.bottom == self.scrollView.mj_contentInsetBottom) {
